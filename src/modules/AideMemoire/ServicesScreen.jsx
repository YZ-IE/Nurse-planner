...
export default function ServicesScreen({ cryptoKey, accentColor, onBack, onSelectService, onImport, onPhotoImport }) {
  const C = accentColor;
    ...
    <div style={{ background: T.bg, position: 'absolute', inset: 0, overflowY: 'auto', padding: '20px 20px 50px', boxSizing: 'border-box' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          <button onClick={onPhotoImport}
            style={{ background: '#6366f122', border: '1px solid #6366f144', borderRadius: 10, color: '#6366f1', padding: '8px 14px', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}>📷 Photo</button>
      ...
      {services.length === 0 ? (
        <div style={{ textAlign: 'center', marginTop: 80 }}>
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center' }}>
            <button onClick={onPhotoImport} style={{ background: '#6366f122', border: '1px solid #6366f144', borderRadius: 12, color: '#6366f1', padding: '12px 24px', fontSize: 14, fontWeight: 700, cursor: 'pointer' }}>
              📷 Depuis une photo
            </button>
